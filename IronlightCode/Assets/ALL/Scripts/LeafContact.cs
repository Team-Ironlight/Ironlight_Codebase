...
public class LeafContact : MonoBehaviour
{
    ...
    IEnumerator Work()
    {
        ...
        while (count < activeTime)
        {
            ...
            {                
                ...
                rend.material.SetFloat("_NormalExtrude", value);
            }
    ...
    //    {
    //        //update shader for player position
    //        rend.material.setvector("_playerposition", collision.transform.position);
    //    }
    //}

    //private void oncollisionexit(collision collision)
    //{
    //    rend.material.setfloat("_bodyradius", -1f);
    //}
}
