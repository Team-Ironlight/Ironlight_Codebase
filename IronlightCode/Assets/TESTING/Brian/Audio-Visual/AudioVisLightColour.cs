...
public class AudioVisLightColour : AudioSync
{
    public Light light;
    ...
    public override void onUpdate()
    {
        ...
        if (isBeat) return;
        ConvertVal();
        light.color = Vector4.Lerp(light.color, restColour, restSmoothTime * Time.deltaTime);
    }
    ...
    {
        Vector4 currColour = light.color;
