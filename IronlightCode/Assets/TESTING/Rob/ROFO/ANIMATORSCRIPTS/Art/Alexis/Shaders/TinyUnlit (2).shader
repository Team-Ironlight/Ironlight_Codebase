...
Shader "TinyUnlit"
{
	Properties
	{
		...
		[HDR]_TopColour("TopColour", Color) = (1,0.8820389,0,0)
		[HDR]_BottomColour("BottomColour", Color) = (1,0.496859,0,0)
		_GradientBottom("GradientBottom", Float) = 0.4642553
		_EmissionIntensity("EmissionIntensity", Float) = 1
		_GradientIntensity("GradientIntensity", Float) = 2
	...
	LOD 100
		...
		Pass
		{
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				float smoothstepResult21 = smoothstep( ( _RimIntensity - _Threshold ) , ( _RimIntensity + _Threshold ) , ( 1.0 - dotResult13 ));
				float4 transform31 = mul(unity_ObjectToWorld,float4( 0,0,0,1 ));
				float smoothstepResult39 = smoothstep( 0.0 , 1.0 , ( ( ( transform31.y - ase_worldPos.y ) + _GradientBottom ) * _GradientIntensity ));
				float4 lerpResult35 = lerp( _TopColour , _BottomColour , smoothstepResult39);
				
				
				finalColor = ( ( ( _Albedo * smoothstepResult21 ) + lerpResult35 ) * _EmissionIntensity );
				return finalColor;
			}
			ENDCG
		}
...
/*ASEBEGIN
Version=17500
357.5;576;889;1187;1193.915;-1290.789;2.48296;True;False
Node;AmplifyShaderEditor.WorldPosInputsNode;32;-1022.626,1842.859;Inherit;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.ObjectToWorldTransfNode;31;-1026.894,1634.655;Inherit;False;1;0;FLOAT4;0,0,0,1;False;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;3;-1308.572,749.9363;Inherit;False;Property;_GradientBottom;GradientBottom;5;0;Create;True;0;0;False;0;0.4642553;0.1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleSubtractOpNode;33;-757.3632,1724.38;Inherit;True;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;11;-1216.781,-889.2454;Inherit;False;Constant;_Float0;Float 0;0;0;Create;True;0;0;False;0;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;38;-368.5862,1876.182;Inherit;False;Property;_GradientIntensity;GradientIntensity;7;0;Create;True;0;0;False;0;2;9.47;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;36;-451.6658,1646.325;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;12;-1431.595,59.12698;Inherit;False;Property;_Threshold;Threshold;2;0;Create;True;0;0;False;0;0;0.01;0.01;0.5;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;14;-1433.416,-178.2094;Inherit;False;Property;_RimIntensity;RimIntensity;1;0;Create;True;0;0;False;0;0;0.5;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;37;-95.78621,1596.341;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;24;-1307.678,568.5184;Inherit;False;Property;_BottomColour;BottomColour;4;1;[HDR];Create;True;0;0;False;0;1,0.496859,0,0;1,0.496859,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SmoothstepOpNode;39;263.5826,1496.875;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;20;-1311.3,389.9525;Inherit;False;Property;_TopColour;TopColour;3;1;[HDR];Create;True;0;0;False;0;1,0.8820389,0,0;1,0.8820389,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;23;-937.4763,-937.0692;Inherit;False;Property;_Albedo;Albedo;0;1;[HDR];Create;True;0;0;False;0;1,1,1,0;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;28;1115.194,-1.040156;Inherit;True;Property;_EmissionIntensity;EmissionIntensity;6;0;Create;True;0;0;False;0;1;1.18;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;16;-3.308334,723.1464;Inherit;False;Constant;_Float2;Float 2;6;0;Create;True;0;0;False;0;1;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;2;-1305.656,1257.8;Inherit;False;Constant;_Float3;Float 3;6;0;Create;True;0;0;False;0;1;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;5;-644.1577,879.7884;Inherit;False;Constant;_Float1;Float 1;6;0;Create;True;0;0;False;0;0;0;0;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=29612B688E19842B9FFBC2C2E9863E738162E5B0