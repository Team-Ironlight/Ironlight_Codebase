...
Shader "TinyUnlit"
{
	Properties
	{
		...
		_GradientBottom1("GradientBottom", Range( 0 , 0.9)) = 0.4642553
	...
	LOD 100
		...
		Pass
		{
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				float2 uv01 = i.ase_texcoord2.xy * float2( 1,1 ) + float2( 0,0 );
				float4 lerpResult26 = lerp( _TopColour1 , _BottomColour1 , min( ( max( ( ( 1.0 - uv01.y ) - _GradientBottom1 ) , 0.0 ) * ( 1.0 / _GradientBottom1 ) ) , 1.0 ));
				
				
				finalColor = ( ( ( _Albedo1 * smoothstepResult21 ) + lerpResult26 ) * _EmissionIntensity1 );
				return finalColor;
			}
			ENDCG
		}
...
/*ASEBEGIN
Version=17500
479;154.5;889;697;2088.02;1105.546;2.659991;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;3;-1308.572,749.9363;Inherit;False;Property;_GradientBottom1;GradientBottom;5;0;Create;True;0;0;False;0;0.4642553;0.4642553;0;0.9;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;12;-1431.595,59.12698;Inherit;False;Property;_Threshold1;Threshold;2;0;Create;True;0;0;False;0;0;0.2;0.01;0.5;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;14;-1433.416,-178.2094;Inherit;False;Property;_RimIntensity1;RimIntensity;1;0;Create;True;0;0;False;0;0;0.49;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;24;-1305.589,572.6974;Inherit;False;Property;_BottomColour1;BottomColour;4;1;[HDR];Create;True;0;0;False;0;1,0.496859,0,0;1,0.496859,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=F36308D84B9386DF74E1B877E0FCF5072A74B93A